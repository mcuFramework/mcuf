...
//-----------------------------------------------------------------------------------------
#include "mcuf/io/InputBufferLimit.h"
...
//-----------------------------------------------------------------------------------------
using mcuf::io::InputBufferLimit;
 ...
 * @return int 
 */
int InputBufferLimit::put(mcuf::io::OutputBuffer& outputBuffer){
  if(this->mInputBuffer == nullptr)
    return 0;
 ...
 */
mcuf::io::InputBuffer* InputBufferLimit::getInputBuffer(void){
 ...
 * @return mcuf::io::InputBuffer* 
 */
mcuf::io::InputBuffer* InputBufferLimit::setInputBuffer(mcuf::io::InputBuffer* inputBuffer){
  mcuf::io::InputBuffer* temp = this->mInputBuffer;

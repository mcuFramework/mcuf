...
//-----------------------------------------------------------------------------------------
#include "mcuf/io/InputStreamHandler.h"
...
//-----------------------------------------------------------------------------------------
using mcuf::io::InputStreamHandler;
 ...
 * @param memory 
 */
InputStreamHandler::InputStreamHandler(InputStream& inputStream ,const mcuf::lang::Memory& memory) :
 ...
 * @return int 
 */
int InputStreamHandler::get(mcuf::io::InputBuffer& inputBuffer){

...
uint8_t* ByteBuffer::lowerArray(void){
  return static_cast<uint8_t*>(this->pointer());
}
...
uint8_t* ByteBuffer::lowerArray(uint32_t offset){
  ...
  return &static_cast<uint8_t*>(this->pointer())[offset];
}
...
char ByteBuffer::getByte(void){
  ...
  return static_cast<uint8_t*>(this->pointer())[this->mPosition++];
}
...
short ByteBuffer::getShortLsb(void){
  ...
  void* ptr = &static_cast<uint8_t*>(this->pointer())[this->mPosition];
  this->mPosition+=2;

...
class mcuf::util::TimerSchedulerSemulator:
  ...
  public: class ConsumerPurge: 
    ...
    public: ConsumerPurge(TimerSchedulerSemulator* base){
      this->base = base;
      this->purge = 0;
    }
  ...
  public: class ConsumerTick: 
    ...
    public: ConsumerTick(TimerSchedulerSemulator* base);
   ...
   * Construct.
   */
  public: TimerSchedulerSemulator(mcuf::util::Pool* pool);
  
  
  /**
   * Disconstruct.
   */
  public: ~TimerSchedulerSemulator();

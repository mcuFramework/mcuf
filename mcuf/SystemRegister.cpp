 ...
 */
void SystemRegister::setInterfaceKernel(mcuf::InterfaceKernel* interfaceKernel){
 ...
 */
void SystemRegister::setInterfaceThread(mcuf::InterfaceThread* interfaceThread){
 ...
 */
void SystemRegister::setInterfaceTimer(mcuf::InterfaceTimer* interfaceTimer){

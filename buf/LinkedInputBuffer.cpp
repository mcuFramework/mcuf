 ...
 */
int LinkedInputBuffer::put(mcuf::OutputBuffer& outputBuffer){
 ...
 * @return int 移動資料數量(byte)
 */
int LinkedInputBuffer::put(mcuf::OutputBuffer& outputBuffer, int length){

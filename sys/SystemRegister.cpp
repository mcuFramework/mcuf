 ...
 * @param printStream 
 */
void SystemRegister::setPrintStream(cli::PrintStream* printStream){
 ...
 * @param task 
 */
void SystemRegister::setIdleTask(func::RunnableEntity task){
  this->mIdleTask = task;
  return;
}
 ...
 */
void SystemRegister::setInterfaceKernel(rtos::InterfaceKernel* interfaceKernel){
 ...
 */
void SystemRegister::setInterfaceThread(rtos::InterfaceThread* interfaceThread){
 ...
 */
void SystemRegister::setInterfaceTimer(rtos::InterfaceTimer* interfaceTimer){

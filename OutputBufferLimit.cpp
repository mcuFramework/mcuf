...
//-----------------------------------------------------------------------------------------
#include "mcuf/OutputBufferLimit.h"
 ...
 * @return int 
 */
int OutputBufferLimit::get(mcuf::InputBuffer& inputBuffer){
  if(this->mOutputBuffer == nullptr)
    return 0;
 ...
 * @return int 
 */
int OutputBufferLimit::get(mcuf::InputBuffer& inputBuffer, int length){
  if(this->mOutputBuffer == nullptr)
    return 0;
 ...
 */
mcuf::OutputBuffer* OutputBufferLimit::getOutputBuffer(void){
 ...
 * @return mcuf::OutputBuffer* 
 */
mcuf::OutputBuffer* OutputBufferLimit::setOutputBuffer(mcuf::OutputBuffer* outputBuffer){
  mcuf::OutputBuffer* temp = this->mOutputBuffer;
